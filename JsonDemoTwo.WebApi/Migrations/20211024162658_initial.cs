    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Antipolo City", "123 Adarna Street", "Apartment 307", "12345" });

            migrationBuilder.InsertData(
                table: "Company",
                columns: new[] { "Id", "Bs", "CatchPhrase", "Name" },
                values: new object[] { 1, "harness real-time guards", "The guards you can trust", "Dagohoy Services" });

            migrationBuilder.InsertData(
                table: "Geo",
                columns: new[] { "Id", "Lat", "Lng" },
                values: new object[] { 1, -622346m, -166032m });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AddressId", "CompanyId", "Email", "GeoId", "Name", "Phone", "UserName", "Website" },
